/******************************************************************************
** embed_rank.hpp
** Interface for embed_rank utility function
** $Id: embed_rank.hpp,v 1.1.1.2 2005/01/27 03:02:21 cwwang Exp $
** $Revision: 1.1.1.2 $
** 
...
#ifndef __MPIBLAST_EMBED_RANK
#define __MPIBLAST_EMBED_RANK

#include <objseq.h>

void setSeqAnnotRank(SeqAnnotPtr sap, int rank, int node_count);

#endif // __MPIBLAST_EMBED_RANK
